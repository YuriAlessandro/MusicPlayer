 ...
 */
public class SairConfirmar extends javax.swing.JDialog {

    /**
     * Creates new form SairConfirmar
     */
    public SairConfirmar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SairConfirmar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SairConfirmar dialog = new SairConfirmar(new javax.swing.JFrame(), true);
